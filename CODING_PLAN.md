...
实施记录（2026-09-07）：0.5.0 已完成 W02–W04。当前具备严格 JSON/原子备份基础、PBKDF2-HMAC-SHA256 随机盐凭据、管理员首次初始化、用户/骑手注册、商家账号与店铺原子注册、四角色登录注销及真实页面路由；相应规则、持久化、认证和 UI 契约测试通过。目录/购物车、订单闭环、管理统计与恢复 UI 按 W05–W08 实施。
