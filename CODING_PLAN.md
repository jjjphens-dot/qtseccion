...
实施记录（2026-09-07）：0.4.0 已完成 W02，并完成 W03 的全实体严格 JSON 编解码、加载/保存双向不变量校验、QSaveFile 原子主文件、上一有效版本 `.bak` 及可恢复状态报告；持久化基础测试通过。恢复确认 UI 仍在 W08，认证与业务 Service 按 W04–W07 实施。
