...
实施记录（2026-09-07）：0.6.0 已完成 W02–W05。当前具备严格 JSON/原子备份基础、PBKDF2-HMAC-SHA256 随机盐凭据、管理员首次初始化、用户/骑手注册、商家账号与店铺原子注册、四角色登录注销及真实页面路由；W05 已补齐资料/营业状态、菜品 CRUD、Shop/Dish/Cart Model 与顾客购物车提交/恢复。规则、持久化、认证、目录购物车和 UI 契约测试通过。订单闭环、管理统计与恢复 UI 按 W06–W08 实施。
