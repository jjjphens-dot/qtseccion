...
- Merchant 页面按“店铺与菜品 / 订单与统计”分区，长内容可滚动且订单表独立伸缩；Customer 页面在小窗口下可整页滚动。960×640 至 1440×900 及 100%/125%/150% 缩放的本机 UI 验收已通过。
...
课程验收报告仍未完成；当前任务已完成 PBKDF2 后台摘要计算、恢复资格/锁保护、混合态性能样本和 Merchant UI 回归修复，报告不在本轮范围。
